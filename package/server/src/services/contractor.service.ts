...
async function findContractorImageAsync(
  contractorId: string,
  filename: string,
...
async function deleteContractorImageAsync(filename: string) {
...
export default { findContractorImageAsync, deleteContractorImageAsync };
